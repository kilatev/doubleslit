...
*/
quil.middleware.fun_mode = (function fun_mode(options){return quil.middlewares.fun_mode.fun_mode.call(null,options);
});
/**
...
*/
quil.middleware.navigation_3d = (function navigation_3d(options){return quil.middlewares.navigation_3d.navigation_3d.call(null,options);
});
